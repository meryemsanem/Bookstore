...
Bookstore is an application that allows users to do these:
...
- Add and remove book from the book list
- Comment or edit the selected book
...
```sh
  git clone git@github.com:meryemsanem/bookstore.git
```
